...
#DIALOGUE TREE FILE
DIALOGUE_FILENAME = "apollo_capsule.json"
...
NPC_NAME = "NPC_ApolloCapsule"
NPC_GLTF_URL = FILESTORE+"store/users/johnchoi/Objects/Apollo/apollo_exterior-24k-2048.glb"
NPC_ICON_URL = FILESTORE+"store/users/johnchoi/Objects/Apollo/NASM-NASM2016-01617_screen.jpg"

#ENTER/EXIT SPECIAL EVENT NODES 
ENTER_INTERVAL = 100
ENTER_DISTANCE = 10
ENTER_NODE = "Apollo Command Module Carrier"
EXIT_NODE = "Exit"
...
ROOT_POSITION = Position(-2.0,1,-.5) #This is the start position
...
PLANE_POSITION = Position(0,0.3,0.5)
...
SPEECH_BUBBLE_POSITION = Position(-.1,-.2,.65)
SPEECH_BUBBLE_ROTATION = Rotation(-30,0,0)
...
CHOICE_BUBBLE_POSITION = Position(0.65, 0, 0.4)
